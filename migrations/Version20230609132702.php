 ...
 */
final class Version20230609132702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, room_id INT DEFAULT NULL, student_class_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, start DATETIME NOT NULL, duration INT NOT NULL, end DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_3BAE0AA754177093 (room_id), INDEX IDX_3BAE0AA7598B478B (student_class_id), INDEX IDX_3BAE0AA741807E1D (teacher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
