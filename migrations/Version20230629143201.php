 ...
 */
final class Version20230629143201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_programmes_lecons (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE type_programmes');
        $this->addSql('ALTER TABLE lecons DROP FOREIGN KEY FK_C74C24E0F5E7B85A');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecons DROP FOREIGN KEY FK_C74C24E0F5E7B85A');
        $this->addSql('ALTER TABLE programmes DROP FOREIGN KEY FK_3631FC3FD04C7E15');
        $this->addSql('CREATE TABLE type_programmes (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
