...
class AgendaController extends AbstractController
{
    ...
    /**
     * @Route("/event/edit/{id}", name="edit_event", methods={"GET", "POST"})
     */
    public function admineditEvent(Request $request, EntityManagerInterface $entityManager, Event $event): Response
    {
...
switch ($modificationScope) {
     ...
     */
    public function admindeleteEvent(Event $event, EntityManagerInterface $entityManager): Response
    {
        $entityManager = $this->getDoctrine()->getManager();
        if ($event->getRecurrence() == 1) {
